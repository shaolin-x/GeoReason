...
client_gpt_1 = OpenAI(   " ")
client_gpt_2 = OpenAI(   "  ")
# Two model names gpt-4.1 o4-mini
model_name_1 = "gpt-4.1"
model_name_2 = "o3-mini"

# Input and output directory configuration
input_dir = "prompts_topology_new_two_shots/"
output_dir_1 = "answers_topology_gpt-4.1_new_two_shots"
output_dir_2 = "answers_topology_o3-mini_new_two_shots"
...
for txt_file in txt_files:
    ...
    # try:
    #     response_1 = client_gpt_1.chat.completions.create(
    #         model=model_name_1,
    #         messages=messages
    #     )
    ...
    try:
        response_2 = client_gpt_1.chat.completions.create(
            model=model_name_2,
            messages=messages
        )
